const initial = {name: "Alice", age: 30, address: { streat: "Patission", num: 76}}

//1. With Spreading.Speed operator give a shallow copy
...
const initial2 = {name: "Alice", age: undefined, address: { streat: "Patission", num: 76}}
